...
data40 <- read.table("Estimates_Scenario_10_n40.txt", h=T)
data80 <- read.table("Estimates_Scenario_10_n80.txt", h=T)
data160 <- read.table("Estimates_Scenario_10_n160.txt", h=T)
data320 <- read.table("Estimates_Scenario_10_n320.txt", h=T)
...
boxplot(MLE_gama3_n40,
        ...
        ylim=c(min(gama3),
               max(gama3)), 
        cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(h = 1.4,lty=2,lwd=2, col = "red")
dev.off()
