...
data40 <- read.table("Estimates_Scenario_O 5_n40.txt", h=T)
data80 <- read.table("Estimates_Scenario_O 5_n80.txt", h=T)
data160 <- read.table("Estimates_Scenario_O 5_n160.txt", h=T)
data320 <- read.table("Estimates_Scenario_O 5_n320.txt", h=T)
...
boxplot(MLE_beta2_n40,
        ...
        ylim=c(min(beta2), 
               max(beta2)), 
        cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(h = 4.2,lty=2,lwd=2, col = "red")
dev.off()
