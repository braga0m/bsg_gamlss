...
data40 <- read.table("Estimates_Scenario_O 4_n40.txt", h=T)
data80 <- read.table("Estimates_Scenario_O 4_n80.txt", h=T)
data160 <- read.table("Estimates_Scenario_O 4_n160.txt", h=T)
data320 <- read.table("Estimates_Scenario_O 4_n320.txt", h=T)
...
abline(h=0.8,lty=3,lwd=2, col = "red")
dev.off()
...
boxplot(MLE_gama2_n40,
        ...
        ylim=c(min(gama2),
               max(gama2)), 
        cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(h = 1.6,lty=2,lwd=2, col = "red")
dev.off()
