...
data40 <- read.table("Estimates_Scenario_2_1_n40.txt", h=T)
data80 <- read.table("Estimates_Scenario_2_1_n80.txt", h=T)
data160 <- read.table("Estimates_Scenario_2_1_n160.txt", h=T)
data320 <- read.table("Estimates_Scenario_2_1_n320.txt", h=T)
