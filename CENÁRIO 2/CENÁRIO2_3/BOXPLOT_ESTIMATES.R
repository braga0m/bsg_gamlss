...
data40 <- read.table("Estimates_Scenario_2_3_n40.txt", h=T)
data80 <- read.table("Estimates_Scenario_2_3_n80.txt", h=T)
data160 <- read.table("Estimates_Scenario_2_3_n160.txt", h=T)
data320 <- read.table("Estimates_Scenario_2_3_n320.txt", h=T)
